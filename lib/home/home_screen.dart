  ...
  _buildPopMenuItem(int iconName,String title){
    return Row(
      children: <Widget>[
        ...
        Text(title,style:TextStyle(color:const Color(AppColors.AppBarPopMenuTextColor)))
      ],
    );
  }
  @override
  Widget build(BuildContext context) {
    final BottomNavigationBar botNavBar = BottomNavigationBar(
      ...
      onTap: (int index) {
        setState((){
          _currentIndex=index;
          _pageController.animateToPage(_currentIndex, duration: Duration(microseconds: 10), curve: Curves.easeInOut);
        });
      },
    );
    return Scaffold(
